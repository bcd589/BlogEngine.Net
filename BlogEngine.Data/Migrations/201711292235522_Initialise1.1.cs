namespace BlogEngine.Data.Migrations
{
    ...
    public partial class Initialise11 : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.BlogCatagories", t => t.BlogCatagoryId, cascadeDelete: false)
                .ForeignKey("dbo.BlogTypes", t => t.BlogTypeId, cascadeDelete: false)
                ...
                c => new
                    {
                        ...
                        Username = c.String(),
                        Password = c.String(),
                        IsVarified = c.Boolean(nullable: false),
